...
__export(client_exports, {
  apply: () => apply,
  compactionStatusColor: () => compactionStatusColor,
...
function compactionStatusColor(status) {
  if (status === void 0 || status.presetGenerated !== true) return "rgba(128, 128, 128, 0.55)";
...
function QwenLocalSectionEntry({ useLocale, load, save, setup, setDefault }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      draft.dialect === "ninfer" ? React.createElement(
        Field,
        { label: t.thinkingAll },
      ...
      React.createElement(
        "div",
        { style: { display: "flex", gap: 8, marginBottom: 8, opacity: draft.dialect === "ninfer" ? 0.45 : 1 } },
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { style: { fontSize: 11, opacity: 0.75, lineHeight: 1.4, marginBottom: 4, display: "flex", alignItems: "flex-start", gap: 6 } },
      ...
      compaction.presetGenerated !== true ? React.createElement("button", {
        type: "button",
        disabled: state.actionBusy !== null,
        onClick: doGenerate,
        style: ACTION_STYLE
      }, state.actionBusy === "generate" ? t.generating : t.generate) : null,
      compaction.presetGenerated === true && compaction.defaultPreset !== PRESET_ID ? React.createElement("button", {
        type: "button",
        disabled: state.actionBusy !== null,
        onClick: doSetDefault,
        style: ACTION_STYLE
      }, state.actionBusy === "setDefault" ? t.settingDefault : t.setDefault) : null,
      state.actionError !== null ? React.createElement("div", { style: { fontSize: 11, opacity: 0.8, lineHeight: 1.4, marginBottom: 8, color: "#f87171" } }, state.actionError) : null,
  ...
  ctx.slots.inject("settings.section", () => ctx.slots.register(
    {
      ...
      inject: () => ({
        ...
        setup: async () => {
          ...
          if (service === void 0) return { ok: false, error: "the host plugin did not provide the setup service; restart DSH" };
...
var inject = ["slots", "locale", "remote", "remote.settings", "qwen38LocalQol"];
