...
function toDraft(value) {
  ...
  const line = (name2) => {
    ...
    return {
      ...
      toolChars: String(raw?.summarize?.toolChars ?? value.summarize?.toolChars ?? 2e3)
    };
  };
  const active = legacy ? {
...
function QwenLocalSectionEntry({ useLocale, load, save }) {
  ...
  const doSave = async () => {
    ...
    const numbers = [
      ...
      draft2.keepTurns,
      draft2.toolChars,
      draft2.parkedDefaultBudget,
      draft2.parkedKeepTurns,
      draft2.parkedToolChars
    ];
    ...
    const patch = {
      ...
      lines: {
        [draft2.dialect]: lineBlock(draft2.baseURL, draft2.model, draft2.displayName, draft2.contextWindow, draft2.maxTokens, draft2.low, draft2.medium, draft2.xhigh, draft2.defaultBudget, draft2.images, draft2.keepTurns, draft2.toolChars),
        [otherDialect]: lineBlock(draft2.parkedBaseURL, draft2.parkedModel, draft2.parkedDisplayName, draft2.parkedContextWindow, draft2.parkedMaxTokens, draft2.parkedLow, draft2.parkedMedium, draft2.parkedXhigh, draft2.parkedDefaultBudget, draft2.parkedImages, draft2.parkedKeepTurns, draft2.parkedToolChars)
      },
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", value: draft.contextWindow, onChange: (e) => {
            setDraft({ contextWindow: e.target.value });
          } })
        ),
        React.createElement(
          Field,
          { label: t.maxTokens },
          React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", value: draft.maxTokens, onChange: (e) => {
            setDraft({ maxTokens: e.target.value });
          } })
        )
      )
    ),
    React.createElement(
      ...
      ninfer ? React.createElement(
        Field,
        { label: t.thinkingAll },
        React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", value: draft.defaultBudget, onChange: (e) => {
          setDraft({ defaultBudget: e.target.value });
        } })
      ) : null,
      React.createElement(
        "div",
        ...
        ["low", "medium", "xhigh"].map(
          (effort) => React.createElement(
            ...
            React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", disabled: ninfer, value: draft[effort], onChange: (e) => {
              setDraft({ [effort]: e.target.value });
            } })
          )
        )
      ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Field,
          { label: t.keepTurns },
          React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", value: draft.keepTurns, onChange: (e) => {
            setDraft({ keepTurns: e.target.value });
          } })
        ),
        React.createElement(
          Field,
          { label: t.toolChars },
          React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", value: draft.toolChars, onChange: (e) => {
            setDraft({ toolChars: e.target.value });
          } })
        )
      )
    ),
