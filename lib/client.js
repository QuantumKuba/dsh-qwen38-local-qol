  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      ninfer ? React.createElement(
        Field,
        { label: t.thinkingAll },
        React.createElement(import_dsh_client_ui_primitives.Input, { className: "qol-input", inputMode: "numeric", value: draft.defaultBudget, onChange: digitsOnly((v) => {
          setDraft({ defaultBudget: v });
        }) })
      ) : null,
      React.createElement(
        "div",
