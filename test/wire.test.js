...
test('buildQwenBody: omlx dialect — effort top-level, native thinking_budget field', () => {
  const body = buildQwenBody(
    { model: 'Qwen3.8-27B-MLX-8bit', reasoningEffort: 'medium', maxTokens: 16384, messages: [] },
